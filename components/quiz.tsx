...
const quizQuestions = [
  {
    ...
    correct: 1,
    explanation: 'Chiến dịch Operation Linebacker II diễn ra từ 18/12 đến 29/12/1972, kéo dài 12 ngày đêm.'
  },
  {
    id: 2,
    ...
    correct: 2,
    explanation: 'B-52 Stratofortress là máy bay ném bom hạng nặng được gọi là "pháo đài bay" của Mỹ lúc bấy giờ.'
  },
  {
    id: 3,
    ...
    correct: 2,
    explanation: 'Phi công Phạm Tuân bắn rơi chiếc B-52 ném bom chiến lược vào đêm 27/12/1972 trong cuộc bảo vệ bầu trời Hà Nội.'
  },
  {
    id: 4,
    ...
    correct: 0,
    explanation: 'Phi công Vũ Xuân Thiệu anh dũng hy sinh vì tổ quốc bằng cách đâm vào chiếc B-52 còn mang bom ở tuổi 27.'
  },
  {
    id: 5,
    ...
    correct: 2,
    explanation: 'Ngày 26/12/1972 là ngày Mỹ mở đợt ném bom lớn nhất trong chiến dịch, với trận chiến ác liệt nhất và nhiều máy bay B-52 bị bắn rơi nhất.'
  },
  {
    id: 6,
    ...
    correct: 2,
    explanation: 'Chiến thắng được gọi là "Điện Biên Phủ trên không" để so sánh với chiến thắng lịch sử năm 1954 khi Việt Nam đánh bại quân đội Pháp.'
  },
]
        ...
        <div className="max-w-2xl mx-auto">
          <div className="bg-card rounded-lg p-12 border border-accent/50 text-center">
            ...
            <p className="text-2xl text-muted-foreground mb-2">
              {percentage === 100 ? '🏆 Xuất sắc!' : percentage >= 80 ? '⭐ Rất tốt!' : percentage >= 60 ? '✓ Tốt' : '💪 Cố gắng thêm!'}
            </p>
    ...
    <section className="py-20 px-4 bg-background">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground">Thử thách bản thân với những câu hỏi về chiến thắng Điện Biên Phủ trên không</p>
        ...
        <div className="bg-card rounded-lg p-8 border border-accent/50 mb-8">
          ...
          {showResult && (
            <div className={`p-4 rounded-lg mb-6 ${
              ...
              <p className="text-sm">{isCorrect ? '✓ Chính xác!' : 'ℹ️ Giải thích:'} {question.explanation}</p>
            </div>
          )}
        </div>
