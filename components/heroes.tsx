...
const heroes = [
  {
    ...
    fullBio:
      'Phi công anh dũng của Không quân Việt Nam. Đêm 27/12/1972, ông bắn rơi một máy bay ném bom chiến lược B-52 Stratofortress của Mỹ trong chiến dịch bảo vệ bầu trời Hà Nội. Sau này ông trở thành người Việt Nam và người châu Á đầu tiên bay vào vũ trụ (1980).',
  ...
  },
  {
    ...
    fullBio:
      'Một trong những phi công bắn rơi nhiều máy bay Mỹ nhất trong chiến tranh Việt Nam. Với 9 chiến tích, anh đã góp phần quan trọng trong việc bảo vệ bầu trời miền Bắc Việt Nam khỏi các cuộc tấn công của không quân Mỹ.',
  ...
  },
  {
    ...
    fullBio:
      'Phi công anh dũng hy sinh cho tổ quốc. Sau khi phóng hai tên lửa nhưng chưa hạ được mục tiêu, ông chủ động điều khiển máy bay đâm thẳng vào chiếc B-52 còn mang bom, tiêu diệt đối phương. Ông hy sinh ở tuổi 27 và được truy tặng danh hiệu Anh hùng Lực lượng vũ trang nhân dân.',
  ...
  },
  {
    ...
    fullBio:
      'Một trong những chỉ huy quan trọng của Quân chủng Phòng không - Không quân Việt Nam. Ông chỉ đạo tổ chức hệ thống phòng không bảo vệ miền Bắc, phối hợp các lực lượng tên lửa, pháo phòng không, radar và không quân tiêm kích một cách hiệu quả.',
  ...
  },
  {
    ...
    fullBio:
      'Phi công tiêm kích của Không quân Việt Nam. Từ 1966 đến 1968, cùng đồng đội tham gia chiến đấu và trực tiếp bắn rơi 8 máy bay của đối phương. Sau chiến tranh trở thành Tướng lĩnh Quân đội nhân dân Việt Nam. Được phong danh hiệu Anh hùng Lực lượng vũ trang nhân dân.',
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground mb-4">
            Các anh hùng lịch sử - Chiến sĩ anh dũng bảo vệ bầu trời Hà Nội
          </p>
